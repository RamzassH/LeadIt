...
export const Container = styled("div")`
    ...
    align-items: center;
    background: linear-gradient(270.00deg, rgb(120, 189, 196),rgb(247, 248, 243) 68.189%);
`;
...
export const BackgroundContainer = styled("div")`
    ...
    border-radius:  calc(180rem/16) 0 0 calc(180rem/16);
...
export const NonBackgroundContainer = styled("div")`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
