import "./local.css"
import gif from "../../../public/images/goida.gif"
    ...
    return (
        <body>
            <header className="header">
                ...
                <div className="logo">
                    <svg className="logo-image" width="27.257812" height="34.171875" viewBox="0 0 27.2578 34.1719" fill="none"
                    ...
                    <div className="menu-drop-list">
                        <div className="menu-item">
                            ...
                            <div className="menu-item-drop-list-icon">
                                <svg className="menu-item-drop-list-icon-image" width="7.548340" height="13.506104" viewBox="0 0 7.54834 13.5061" fill="none"
                                     xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    <desc>
                                        Created with Pixso.
                                    </desc>
