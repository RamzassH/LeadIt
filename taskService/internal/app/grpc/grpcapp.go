...
import (
	...
	taskgrpc "github.com/RamzassH/LeadIt/taskService/internal/grpc/task"
...
func New(
	...
	cfg *config.Config,
	validator *validator.Validate,
	taskService taskgrpc.Service) *App {
	gRPCServer := grpc.NewServer(
		grpc.UnaryInterceptor(interceptors.JwtUnaryServerInterceptor(cfg.TokenSecret)))

	taskgrpc.RegisterGRPCServer(gRPCServer, validator, log, taskService)
