...
const (
	TopicService_CreateTopic_FullMethodName        = "/agile.TopicService/CreateTopic"
	TopicService_GetTopic_FullMethodName           = "/agile.TopicService/GetTopic"
	TopicService_GetTopicsByProject_FullMethodName = "/agile.TopicService/GetTopicsByProject"
	TopicService_UpdateTopic_FullMethodName        = "/agile.TopicService/UpdateTopic"
	TopicService_DeleteTopic_FullMethodName        = "/agile.TopicService/DeleteTopic"
)
...
type TopicServiceClient interface {
	...
	GetTopic(ctx context.Context, in *GetTopicRequest, opts ...grpc.CallOption) (*TopicType, error)
	GetTopicsByProject(ctx context.Context, in *GetTopicsByProjectRequest, opts ...grpc.CallOption) (*GetTopicsByProjectResponse, error)
	UpdateTopic(ctx context.Context, in *UpdateTopicRequest, opts ...grpc.CallOption) (*TopicType, error)
...
func (c *topicServiceClient) GetTopic(ctx context.Context, in *GetTopicRequest, opts ...grpc.CallOption) (*TopicType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TopicType)
...
func (c *topicServiceClient) GetTopicsByProject(ctx context.Context, in *GetTopicsByProjectRequest, opts ...grpc.CallOption) (*GetTopicsByProjectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTopicsByProjectResponse)
	err := c.cc.Invoke(ctx, TopicService_GetTopicsByProject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicServiceClient) UpdateTopic(ctx context.Context, in *UpdateTopicRequest, opts ...grpc.CallOption) (*TopicType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TopicType)
...
type TopicServiceServer interface {
	...
	GetTopic(context.Context, *GetTopicRequest) (*TopicType, error)
	GetTopicsByProject(context.Context, *GetTopicsByProjectRequest) (*GetTopicsByProjectResponse, error)
	UpdateTopic(context.Context, *UpdateTopicRequest) (*TopicType, error)
...
func (UnimplementedTopicServiceServer) GetTopic(context.Context, *GetTopicRequest) (*TopicType, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTopic not implemented")
}
func (UnimplementedTopicServiceServer) GetTopicsByProject(context.Context, *GetTopicsByProjectRequest) (*GetTopicsByProjectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTopicsByProject not implemented")
}
func (UnimplementedTopicServiceServer) UpdateTopic(context.Context, *UpdateTopicRequest) (*TopicType, error) {
...
func _TopicService_GetTopicsByProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTopicsByProjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopicServiceServer).GetTopicsByProject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TopicService_GetTopicsByProject_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopicServiceServer).GetTopicsByProject(ctx, req.(*GetTopicsByProjectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TopicService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agile.TopicService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTopicsByProject",
			Handler:    _TopicService_GetTopicsByProject_Handler,
		},
		{
	...
	Metadata: "agile/topic/topic.proto",
}
