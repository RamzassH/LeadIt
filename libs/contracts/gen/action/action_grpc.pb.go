...
const (
	Action_CreateAction_FullMethodName     = "/action.Action/CreateAction"
	Action_GetActionsByTask_FullMethodName = "/action.Action/GetActionsByTask"
)
...
type ActionClient interface {
	...
	GetActionsByTask(ctx context.Context, in *GetActionsByTaskRequest, opts ...grpc.CallOption) (*GetActionsByTaskResponse, error)
}
...
func (c *actionClient) CreateAction(ctx context.Context, in *CreateActionRequest, opts ...grpc.CallOption) (*CreateActionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateActionResponse)
	err := c.cc.Invoke(ctx, Action_CreateAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionClient) GetActionsByTask(ctx context.Context, in *GetActionsByTaskRequest, opts ...grpc.CallOption) (*GetActionsByTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetActionsByTaskResponse)
	err := c.cc.Invoke(ctx, Action_GetActionsByTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActionServer interface {
	...
	GetActionsByTask(context.Context, *GetActionsByTaskRequest) (*GetActionsByTaskResponse, error)
...
func (UnimplementedActionServer) CreateAction(context.Context, *CreateActionRequest) (*CreateActionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAction not implemented")
}
func (UnimplementedActionServer) GetActionsByTask(context.Context, *GetActionsByTaskRequest) (*GetActionsByTaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActionsByTask not implemented")
}
...
func _Action_CreateAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Action_CreateAction_FullMethodName,
	}
...
func _Action_GetActionsByTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActionsByTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActionServer).GetActionsByTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Action_GetActionsByTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActionServer).GetActionsByTask(ctx, req.(*GetActionsByTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Action_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetActionsByTask",
			Handler:    _Action_GetActionsByTask_Handler,
		},
	},
